...
class PostProcessor:
    ...
    def __init__(self,file_path = '../NATS_Standalone', \
        ...
        if not os.path.exists(self.path_to_csv):
            ...
            if not self.searchAndChangePath():
                print 'No NATS HOME folder found. Exiting.'
                quit();
    ...
    '''Change Path if wrong path given for NATS HOME'''
