...
# 10.09.2019
#
# This program read data file generated from XPlane simulator and send it to NATS
#
# Notice!
...
XPLANE_PATH = "./sample/DEMO_XPlane"
                ...
                if (not(tmpState is None)) :
                    ...
                    if (not(currentState is None)) and (len(currentState) == num_valid_state) :
                        ...
                        if (traj_ac_id not in list(aircraftInterface.getAllAircraftId())) :
                            ...
                            print "Sending external aircraft trajectory data to NATS at UTC time = ", t
