...
class NATS_MonteCarlo_Interface:
    ...
    def initializeJVM(self, client_dir = './'):
        ...
        self.clsNATSStandalone = JClass('NATSStandalone')
        # Start NATS Standalone environment
        self.natsStandalone = self.clsNATSStandalone.start()
        
        if (self.natsStandalone is None) :
            print "Can't start NATS Standalone"
            quit()
    
        self.equipmentInterface = self.natsStandalone.getEquipmentInterface();

        # Get EnvironmentInterface
        self.environmentInterface = self.natsStandalone.getEnvironmentInterface();
        ...
        self.sim = self.natsStandalone.getSimulationInterface()
                
        self.aircraftInterface = self.equipmentInterface.getAircraftInterface(); 
        
        self.entityInterface = self.natsStandalone.getEntityInterface();
